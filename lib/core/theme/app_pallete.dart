...
class AppPallete {
  ...
  static const Color primaryAppColor = Color.fromRGBO(0, 0, 0, 1);
  static const Color primaryAppButtonColor = Color.fromRGBO(0, 0, 0, 1);
  ...
  static const Color shadowblurColor = Color.fromRGBO(0, 0, 0, 1);
